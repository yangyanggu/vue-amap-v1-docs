import{_ as g,f as _,j as c,I as v,o as x,c as h,a as P,h as j}from"./app.73ff0094.js";const y=["value"],S=_({__name:"vp-codepen",props:{css:{type:String,required:!0},cssPreProcessor:{type:String,required:!0},js:{type:String,required:!0},jsPreProcessor:{type:String,required:!0},html:{type:String,required:!0}},setup(a,{expose:i}){const t=a,u={"'vue'":"Vue","'element-plus'":"ElementPlus"},m=c(()=>{const e=decodeURIComponent(t.js||""),s=/(import*) ([^'\n]*) from ([^\n]*)/g,n=[];let p;for(;p=s.exec(e);){const[,,l,f]=p;n.push(`const ${l} = ${u[f]};`)}let r=(e.includes("export default defineComponent")?/export default defineComponent\({([\s\S]*)}\)/g:/export default {([\s\S]*)}/g).exec(e);return r=(r&&r[1]||"").replace(/\n {2}/g,`
`).trim(),`${n.join(`
`)}
var Main = {
  ${r}
